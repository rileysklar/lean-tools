...
export const metadata: Metadata = {
  ...
  description: 'Real-time monitoring and analytics for production optimization across all manufacturing cells and operations. Track machine cycles, identify bottlenecks, and measure efficiency.',
  keywords: ['manufacturing', 'efficiency', 'dashboard', 'lean tools', 'production', 'analytics', 'operations'],
